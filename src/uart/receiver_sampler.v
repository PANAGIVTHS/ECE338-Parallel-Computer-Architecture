module receiver_sampler(clk, reset, enable, sample_pulse, data, sample_mid, sample_done, previous_bit, current_bit);
    ...
    assign sample_mid = sample_counter == 3'd4 && sample_pulse;
    assign sample_done = sample_counter == 3'd7 && sample_pulse;
    ...
    always @(posedge clk) begin
        if (!reset) begin
            ...
            previous_bit <= 1'b0;
        end else if (enable && sample_counter == 3'b000 && sample_pulse) begin
            previous_bit <= data;
