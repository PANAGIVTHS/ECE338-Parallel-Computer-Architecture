module HazardUnit (
    ...
    always @(*) begin
        ...
        if (i_ex_wen && (i_idex_rd != 5'b0) && (i_id_rs1 == i_idex_rd || i_id_rs2 == i_idex_rd)) begin
            o_data_hazard = 1'b1;
        //! Multiplier RAW Hazards
        end else if (i_mul1_valid && (i_mul1_rd != 5'b0) && (i_id_rs1 == i_mul1_rd || i_id_rs2 == i_mul1_rd)) begin
            o_data_hazard = 1'b1;
